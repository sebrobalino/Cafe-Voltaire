    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="text-center py-12">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Demo Backend Connection</h2>
          <p className="text-gray-600 mb-6">Test the connection by earning points!</p>

          <button
            onClick={earnPoints}
            className="px-6 py-3 bg-amber-900 text-white rounded-full font-semibold hover:bg-amber-800"
          >
            + EARN 50 POINTS (TEST)
          </button>
        </div>
        ...
        <div className="space-y-3">
          {rewards.map((reward, idx) => (
            <button
              ...
              className={`w-full bg-white rounded-2xl p-5 border text-left transition ${
    ...
    <div className="flex flex-col items-center space-y-8">
      ...
      <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-lg relative">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 font-mono mt-1">#5297735</p>
        </div>
      </div>
    ...
    <div className="max-w-md mx-auto bg-stone-50 min-h-screen flex flex-col">
      ...
      <div className="bg-white border-t border-gray-200 px-8 py-4 fixed bottom-0 left-0 right-0 max-w-md mx-auto">
        ...
        <button
          ...
          className="mt-4 w-full text-center text-xs text-red-600"
        >
          Logout
        </button>
      </div>
